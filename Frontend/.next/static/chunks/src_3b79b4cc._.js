...
"[project]/src/lib/actions/data:ed2468 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2f$data$3a$ed2468__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/actions/data:ed2468 [app-client] (ecmascript) <text/javascript>");
...
function LoginForm() {
    ...
    const onSubmit = (values)=>{
        startTransition(()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2f$data$3a$ed2468__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["login"])(values).then((data)=>{
                if (data.error) {
                    form.reset();
                    toast({
                        title: "Login Error",
...
//# sourceMappingURL=src_3b79b4cc._.js.map