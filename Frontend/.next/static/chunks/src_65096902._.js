...
async function voteOnQuestion(questionId, voteType) {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/questions/".concat(questionId, "/vote"), {
        voteType
    });
    return response.data;
}
async function voteOnAnswer(questionId, answerId, voteType) {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/questions/".concat(questionId, "/answers/").concat(answerId, "/vote"), {
        voteType
    });
    return response.data;
}
async function acceptAnswer(questionId, answerId) {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/questions/".concat(questionId, "/answers/").concat(answerId, "/accept"));
    return response.data;
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
//# sourceMappingURL=src_65096902._.js.map